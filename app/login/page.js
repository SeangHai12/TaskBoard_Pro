    ...
    <div className="min-h-screen bg-zinc-50">
      <div className="mx-auto flex min-h-screen max-w-6xl items-center justify-center px-4 py-10">
        <div className="w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-1 text-sm text-zinc-600">Log in to continue</p>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                type="password"
                className="mt-1 w-full rounded-xl border border-zinc-200 bg-white px-3 py-2 text-zinc-900 placeholder:text-zinc-400 outline-none focus:border-zinc-400"
                placeholder="Your class demo password"
            ...
            <Link
              href="/signup"
              className="block w-full rounded-xl border border-zinc-200 px-4 py-2 text-center text-sm font-semibold text-zinc-800 hover:bg-zinc-50"
            >
              Sign up
            </Link>
